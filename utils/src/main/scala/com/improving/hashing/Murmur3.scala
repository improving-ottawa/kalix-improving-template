 ...
 *
 * Derived from: https://github.com/google/guava/blob/fa95e381e665d8ee9639543b99ed38020c8de5ef/guava/src/com/google/common/hash/Murmur3_128HashFunction.java
 */
object Murmur3 extends HashAlgorithm {
  ...
  private final val C1 = 0x87c37b91114253d5L
  private final val C2 = 0x4cf5ad432745937fL
  ...
  @inline private final def avalanche(length: Long, in1: Long, in2: Long): Long = {
    var h1 = in1 ^ length
    var h2 = in2 ^ length
  ...
  @inline private final def fmix64(in: Long): Long = {
    var k = in ^ in >>> 33
  ...
  @inline private final def mixK1(k1: Long): Long = {
    var res = k1 * C1
    res = rotateLeft(res, 31)
    res * C2
  }

  @inline private final def mixK2(k2: Long): Long = {
    var res = k2 * C2
