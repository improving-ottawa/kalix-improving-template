...
package object config extends ConfigReaderExtensions {
  ...
  object ConfigReader {
    ...
    /**
     * Create a new [[ConfigReader]] that always returns the same value (does not actually read from any configuration).
     */
    ...
    /**
     * Create a new [[ConfigReader]], using a Kleisli function from:
     * [[Config configuration]] => [[Try effect of `R`]].
     */
    ...
    /**
     * Create a new [[ConfigReader]], using a Kleisli function from:
     * [[Config configuration]] => [[Either effect of `R`]].
     */
