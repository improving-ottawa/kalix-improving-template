...
/**
  * Postal Code is a protobuf message that requires to be serialized. Due to the interactions of akka actors EventSourceBehavior, ScalaPB, and oneof, a
  * TypeMapper needs to be implemented with the Json annotations.
  */
