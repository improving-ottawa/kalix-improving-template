...
import {DoNothingTwiceEvent} from "../../../generated/com/example/gateway/domain/gatewayEvents_pb";

export function sendDoNothingTwiceCommand(req: DoNothingTwiceCommand) {
  var deadline = new Date();
  deadline.setSeconds(deadline.getSeconds() + 30);

  return new Promise<{ doNothingTwice: DoNothingTwiceEvent }>((resolve, reject) => {
